...
//        templates.add("vm/java/domain.java.vm");
//        templates.add("vm/java/edit-params.java.vm");
...
//        }
//        if (template.contains("edit-params.java.vm")) {
//            fileName = StrUtil.format("{}/params/{}.java", javaPath, className);
//        }
//        if (template.contains("response.java.vm")) {
//            fileName = StrUtil.format("{}/response/{}.java", javaPath, className);
...
//            fileName = StrUtil.format("{}/service/{}Manager.java", javaPath, className);
...
//            if (!GenUtils.isSuperColumn(column) && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
//                importList.add("java.util.Date");
//                importList.add("com.fasterxml.jackson.annotation.JsonFormat");
//            } else if (!GenUtils.isSuperColumn(column) && GenConstants.TYPE_BIGDECIMAL.equals(column.getJavaType())) {
...
//        for (GenTableColumn column : columns) {
//            if (!GenUtils.isSuperColumn(column) && StrUtil.isNotEmpty(column.getDictType()) && StrUtil.equalsAny(column.getHtmlType(), new String[]{GenConstants.HTML_SELECT, GenConstants.HTML_RADIO, GenConstants.HTML_CHECKBOX})) {
...
//        if (ObjUtil.isNotEmpty(paramsObj) && paramsObj.containsKey(GenConstants.PARENT_MENU_ID) && StrUtil.isNotEmpty(paramsObj.getStr(GenConstants.PARENT_MENU_ID))) {
...
//            if (GenUtils.isTrue(column.getIsList())) {
//                num++;
