package com.gklx.mopga.base.module.support.dict.service;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.gklx.mopga.base.module.support.dict.domain.form.*;
...
import com.gklx.mopga.base.module.support.dict.domain.vo.DictVO;
import com.gklx.mopga.base.module.support.dict.manager.DictManager;
...
public class DictService {
    ...
    public List<DictDataVO> queryDictDataByCode(String dictCode) {
        ...
        return this.queryDictData(dictEntity.getDictId());
    }
