package com.gklx.mopga.base.module.support.job.constant;
...
public class SmartJobUtil {
    ...
    public static void main(String[] args) {
        ...
        ResponseDTO<String> res = checkJobClass("com.gklx.mopga.base.module.support.job.sample.SmartJobSample1");
